...
export default function NewBoat() {
    ...
    const onSubmit = (data: FormData) => {
        Alert.alert("Données envoyées", JSON.stringify(data, null, 2));
        methods.reset();
    };
                    ...
                    <View style={styles.fieldsGroup}>
                        ...
                        <TextField
                            ...
                            rules={{
                                ...
                                pattern: {
                                    value: /^\d+(\.\d{1,2})?$/,
                                    message: "Nombre positif, 2 décimales max.",
                                },
                            }}
                            inputProps={{
                                keyboardType: "numeric",   // ouvre le pavé numérique
                                maxLength: 12,             // optionnel : limite la saisie
                            }}
                        />
                        <TextField
                            name="port"
                    ...
                    <View style={styles.fieldsGroup}>
                        ...
                        <TextField
                            ...
                            rules={{
                                ...
                                min: {
                                    value: 1900,
                                    message: "Trop ancien (>= 1900)"
                                },
                                max: {
                                    value: currentYear,
                                    message: `Ne peut pas dépasser ${currentYear}`,
                                },
                            }}
                            inputProps={{
                        ...
                        <TextField
                            ...
                            rules={{
                                ...
                                pattern: {
                                    value: /^\d+(\.\d{1,2})?$/,       // ex. 12 ou 12.5 ou 12.50
                                    message: "Nombre positif, 2 décimales max.",
                                },
                            }}
                            inputProps={{
                        ...
                        <TextField
                            ...
                            rules={{
                                ...
                                pattern: {
                                    value: /^\d+(\.\d{1,2})?$/,        // ex. 3 ou 3.8 ou 3.80
                                    message: "Nombre positif, 2 décimales max.",
                                },
                            }}
                        ...
                        <TextField
                            ...
                            rules={{
                                ...
                                pattern: {
                                    value: /^\d+$/,                  // uniquement des chiffres
                        ...
                        <TextField
                            ...
                            placeholder="3"
                            rules={{
                                required: "Nombre de cabines obligatoire",
                                pattern: {
                                    value: /^\d+$/,
                                    message: "Entier positif requis",
                                },
                        ...
                        <TextField
                            ...
                            placeholder="8"
                            rules={{
                                required: "Nombre de couchages obligatoire",
                                pattern: {
                                    value: /^\d+$/,
                                    message: "Entier positif requis",
                                },
                        ...
                        <SelectField
                            ...
                            options={[
                                {
                                    label: "A – Navigation hauturière",
                                    value: "A - offshore navigation"
                                },
                                {
                                    label: "B – Navigation au large",
                                    value: "B - coastal navigation"
                                },
                                {
                                    label: "C – Navigation côtière",
                                    value: "C - inshore navigation"
                                },
                                {
                                    label: "D – Navigation abritée",
                                    value: "D - sheltered waters"
                                },
                            ]}
