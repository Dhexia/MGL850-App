...
export { BoatPassport__factory } from "./factories/contracts/BoatPassport__factory";
export type { RoleRegistry } from "./contracts/RoleRegistry";
export { RoleRegistry__factory } from "./factories/contracts/RoleRegistry__factory";
